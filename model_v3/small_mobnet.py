...
class ConvGNActivation(nn.Sequential):  # using GroupNorm or LayerNorm
    def __init__(
        ...
        if activation_layer is None:
            activation_layer = nn.GELU
        super().__init__(
            conv3x3(in_planes, out_planes, kernel_size, stride, padding,
    ...
    if arch == "mobilenet_v3_large":
        inverted_residual_setting = [
            ...
            bneck_conf(112, 5, 672, 160 // reduce_divider,
                       True, False, "HS", 2, dilation),  # C4
            bneck_conf(160 // reduce_divider, 5, 960 // reduce_divider,
                       160 // reduce_divider, True, False, "HS", 1, dilation),
            bneck_conf(160 // reduce_divider, 5, 960 // reduce_divider,
                       160 // reduce_divider, True, False, "HS", 1, dilation),
        ]
        ...
        inverted_residual_setting = [
            bneck_conf(16, 3, 16, 16, True, True, "RE", 2, 1),  # C1
            bneck_conf(16, 3, 72, 24, False, True, "RE", 2, 1),  # C2
            bneck_conf(24, 3, 88, 24, False, True, "RE", 1, 1),
            bneck_conf(24, 5, 96, 40, True, True, "HS", 2, 1),  # C3
            bneck_conf(40, 5, 240, 40, True, False, "HS", 1, 1),
            bneck_conf(40, 5, 240, 40, True, False, "HS", 1, 1),
            bneck_conf(40, 5, 120, 48, True, False, "HS", 1, 1),
            bneck_conf(48, 5, 144, 48, True, False, "HS", 1, 1),
            bneck_conf(48, 5, 288, 96 // reduce_divider,
                       True, False, "HS", 2, dilation),  # C4
            bneck_conf(96 // reduce_divider, 5, 576 // reduce_divider,
                       96 // reduce_divider, True, False, "HS", 1, dilation),
            bneck_conf(96 // reduce_divider, 5, 576 // reduce_divider,
                       96 // reduce_divider, True, False, "HS", 1, dilation),
        ]
        last_channel = adjust_channels(1024 // reduce_divider)  # C5

    elif arch == "mobilenet_v3_xsmall":
        inverted_residual_setting = [
